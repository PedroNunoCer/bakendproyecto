...
function displayProducts() {
    //console.log("Mostrar de la API");
    const productList = document.getElementById('showProducts');
    productList.innerHTML = ''; // Limpiar la lista
    //Obtener productos de Spring Boot
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="product-image">
                        <img src="data:image/jpeg;base64,${product.image}" alt="${product.name}" style="max-width: 100%; max-height: 100%;">
                    </div>
                </div>
                <div class="col-md-7">
                    ...
                    <button class="btn btn-primary" id="" onclick="updateForm(${product.id_product})">
                        <span class="me-2">Modificar Producto</span>
                    </button>
                    
                    <button class="btn btn-primary" onclick="deleteProduct(${product.id_product})">
...
async function saveProduct(productCheese) {
    fetch('http://localhost:8080/api/products/',{
        method: 'POST',
        headers: {
...
function updateForm(id){
    ...
    window.location.href = `../html/productUpdate.html`;
}
displayProducts();